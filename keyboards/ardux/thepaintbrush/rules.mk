...
#     This *should* live in config.h but KemoNine can't figure out how to check which keymap is in use at that level - hi
PINS_HAND_LEFT = -DDIRECT_PINS="{ { F7, F6, F5, F4 }, { D7, E6, B5, B4 } }"
PINS_HAND_RIGHT = -DDIRECT_PINS="{ { F4, F5, F6, F7 }, { B4, B5, E6, D7 } }"
